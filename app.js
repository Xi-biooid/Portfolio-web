...
function smoothScroll(target, duration) {
    ...
    function scrollAnimation(currentTime) {
        ...
        const scrollValue = easeInOutQuad(timeElapsed, startPosition, distance, duration);
...
function moveImages(offset, parallaxOffset, prevPercentage) {
    ...
    images.forEach((image) => {
        ...
        image.style.objectPosition = `${100 + prevPercentage + parallaxOffset}% 50%`; // Increased parallax offset
    });
// ------------------------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------------------------
    ...
    images.forEach((image) => {
        image.style.objectPosition = `${100 + nextPercentage + parallaxOffset}% 50%`; // Increased parallax offset
    });

    return nextPercentage;
}

const scriptURL = 'https://script.google.com/macros/s/AKfycbwn4FHhhKKZg_vOPrjSWCxckWjPVvSp4FEvv8Zg_6RZ9HRWvLFQSJ9RZcJfZBx9Srs8Jw/exec';
...
form.addEventListener('submit', e => {
  ...
  fetch(scriptURL, {
    ...
    .then(response => {
      ...
      setTimeout(() => {
        msg.innerHTML = '<span>Message Sent </span><img src="images/success.gif" alt="Success">';
      }, 5000);
